...
\begin{document}
	...
	そこで問の答えを
	\[
	\cov(\nul) = \min \{ \abs{\mathcal{A}}  : \mathcal{A}\text{はルベーグ測度}0\text{集合の族} \}
	\]
	...
	Kunen-Millerの表というのは次のような表である．\cite{Miller1981SomePO}から抜粋した．Cichońの図式ができる前はこのような表でどの組合せが可能か，可能ならどのモデルかを表していた．
