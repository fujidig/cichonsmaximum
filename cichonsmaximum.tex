...
\begin{document}
	...
	\begin{defi}
		...
		$P$が\textbf{$\lambda$-$\R$-good}であるとは、$Y$の元を表す各$P$名称$\dot{y}$について非空な集合$\mathscr{Y} \subset Y$でサイズ$<\lambda$なものが$V$に存在して、どんな$x \in X$についても$x$が$\mathscr{Y}$上$\relR$非有界であれば、$\forces x \not \sqsubset \dot{y}$.
	\end{defi}
